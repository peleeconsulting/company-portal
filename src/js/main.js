  ...
  header.innerHTML = `
    <div class="container">
      <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="index.html">6ixstack <span class="text-primary">Consulting</span></a>
  ...
  footer.innerHTML = `
    <div class="container">
        ...
        <div class="col-lg-3 footer-widget">
          ...
          <ul class="footer-contact">
            ...
            <li>
              ...
              <div>
                <a href="mailto:mohaimenhasan@gmail.com">mohaimenhasan@gmail.com</a>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="footer-bottom text-center">
        <p class="copyright">© ${new Date().getFullYear()} 6ixstack Consulting. All rights reserved.</p>
      </div>
    </div>
